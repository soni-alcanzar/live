...
'TransactionHistorie','AccountDetail','RequestCatalog','CupanDetail','GiftCupan','GiftCard','GiftCardSegment','FeaturedPrice','PromoteClassDetail','Blog','BlogComment','BlogLike','UserSegment','ConnectGroup','Wishlist','Ngo','ChatMessage','GetQuote','Communitie');
            ...
            $TramID = array();
                      ...
                      for($i=0; $i<$total_coupons; $i++){
                              ...
                              for($j=0;$j<$cupan_no;$j++){
                                      ...
                                      $denmo_no        = $denmo[$i];
                                      $email_id        = $email[$i];
                                      $reciepent_name  = $reciepent_name[$i];
                                      @$catid           = $cat_id[$i];
                                      $comment         = $comment1[$i];
                                      $cupan_id  = rand(10000,100000);
                                      if($catid==''){
    ...
    public function findGiftclass(){
              ...
              $find_gift_class = $this->VendorClasse->query("SELECT bg_vendor_classes.id,
                              ...
                              foreach ($find_gift_class as $key => $value_class) {
                                  ...
                                  $upload_class_photo = 'gymnastics_2_305x148';
                                    }
                                ...
                                $class_list.='<div style="opacity: 1;" class="col-sm-12 col-xs-12 sr_260501 padd_l_r scroll_box_display">
        ...
        foreach ($all_gift_cupan as $key => $value) {
            ...
            /* echo "<pre>";
              ...
              if($no_of_coupons=='555'){
                ...
                else if($reciepent_name!='' and $gift_by=='1' and $gift_type=='2'){
     ...
     ,bg_vendor_classe_location_details.longitude,bg_categories.color_code,bg_categories.id
      ...
      if(!empty($res1)){
       ...
       foreach($res1 as $result){
        $str=$str.'<tr style="background-color:#'.$result['bg_categories']['color_code'].';"><td>'.$i.'</td><td><a href='.HTTP_ROOT."/classes/".$result['bg_vendor_classes']['class_topic'].'>'.$result['bg_vendor_classes']['class_topic'].'</a></td></tr>';
        $i++;
       }
       $str=$str.'</table>';
       echo $str;die;
...
$str=$str.'<thead style="background-color:#00cdc6;">
                                ...
                                $b=count($a);
                                 ...
                                 $str=$str.'</ul>
                                     ...
                                     $str=$str.'<td><a href='.HTTP_ROOT.'/Homes/viewclassDetail/'.base64_encode($result['bg_vendor_classes']['ide']).'>Click to Book</a></td></tr>';
                                    $i++;
                                  }
                                  $str=$str."<tbody>";
                                 print_r($str);die;
...
$str=$str.'<thead style="background-color:#00cdc6;">
                                ...
                                $a = $this->Ticket->find('all',array(      
                                 ...
                                 $str=$str.'</ul>
                                     ...
                                     $str=$str.'<td><a href='.HTTP_ROOT.'/Homes/viewclassDetail/'.base64_encode($result['VendorClasse']['id']).'>Click to Book</a></td></tr>';
                                    $i++;
                                  }
                                  $str=$str."<tbody>";
                                 print_r($str);die;   
 ...
 $res=$this->VendorClasse->query("SELECT bg_vendor_classes.id as ide,bg_vendor_classe_location_details.vendor_class_id, bg_vendor_classes.class_topic,bg_vendor_classe_location_details.latitude, bg_vendor_classe_location_details.longitude,bg_payu_transactions.txnid,bg_tickets.txn_id,bg_tickets.user_id,bg_tickets.vendor_classe_id,SQRT( POW( 69.1 * ( bg_vendor_classe_location_details.latitude - $lat ) , 2 ) + POW( 69.1 * ( bg_vendor_classe_location_details.longitude -$lng ) * COS( $lat / 57.3 ) , 2 ) ) AS distance
...
public function flexibleclassattendance(){
  ...
  $user_id = $user['UserMaster']['id'];
  $this->set('user_view',$user);
  $trans_data = $this->TransactionHistorie->find('all',array(      
      'joins'=>
                array(
                  array(
                  'table'  =>'vendor_classes',  
      ...
      'fields' => 'TransactionHistorie.*,vancs.*',  
  ));
}
                            ...
                            array(
                             ...
                             array(
                              ...
                              array(
                                ...
                                'alias' => 'ConnectGroup',
                                'type'  =>  'INNER',
                                'conditions' => array('Catalog.catalogue_group_id = ConnectGroup.id','ConnectGroup.id'=>$catalog_id)
                                )
...
public function CatalougeClassDetail(){
            ...
            $cc_id  = base64_decode($this->params->pass[0]); 
            $class_type = $this->ClassType->find('all'); 
             
           /* echo "<pre>";
            print_r($class_type);
            echo "</pre>";*/
            $data_cat = $this->VendorClasse->query("SELECT  bg_vendor_classes.id,
                                                               bg_vendor_classes.id,
                                                               bg_vendor_classes.class_topic,
                                                               bg_vendor_classes.class_summary,
                                                               bg_vendor_classes.class_timing_id,  
                                                               ...
                                                               bg_vendor_classes.price_per_head,
                                                               bg_vendor_classes.upload_class_photo,
                                                               bg_vendor_classes.upload_video_name,
                                                               bg_vendor_classes.age_from,
                                                               bg_vendor_classes.age_to,
                                                               bg_vendor_classes.status,
                                                               bg_class_schedules.id,
                                                               bg_class_schedules.session_date,
                                                               bg_vendor_classe_level_details.price, 
                                                               bg_user_masters.first_name,bg_user_masters.id,
                                                               bg_user_masters.yourself,
                                                               bg_class_types.id,
                                                               bg_class_types.types,
                                                               bg_communities.id,
                                                               bg_communities.community_name
                                                               FROM bg_vendor_classes LEFT JOIN bg_class_schedules
                                                               ON bg_vendor_classes.id = bg_class_schedules.class_id
                                                               LEFT JOIN bg_vendor_classe_level_details
                                                               ON bg_vendor_classes.user_id = bg_vendor_classe_level_details.vendor_class_id
                                                               LEFT JOIN bg_user_masters
                                                               ON bg_vendor_classes.id = bg_user_masters.id 
                                                               LEFT JOIN bg_class_types
                                                               ON bg_vendor_classes.class_type_id = bg_class_types.id
                                                               LEFT JOIN bg_communities
                                                               ON bg_vendor_classes.community_id = bg_communities.id
                                                               where bg_vendor_classes.id=$cc_id");
           /* echo "<pre>";
            print_r($data_cat);
            echo "</pre>";
            die;*/
            $this->set('all_class_type',$class_type);
            $this->set('cat_class_detail',$data_cat);
