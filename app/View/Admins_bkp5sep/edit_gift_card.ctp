 		...
 		<div class="row">
 			<div class="col-md-12">
 				<div class="panel panel-default panel-primary">
 					<div class="panel-heading pannel-heading-strip"><i class="fa fa-gift"></i>&nbsp; Edit Gift Card</div>
 					<div class="panel-body">
 							...
 							<div class="login-wrap" style="padding:0;margin:0px auto;">
 								...
 								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
 									<?php echo $this->Form->input('title', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Gift Title','value'=>$edit_gift['GiftCard']['title']));?>
 								...
 								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
 									...
 									'options'=>$card_type,'selected'=>$edit_gift['GiftCard']['card_type_status']));?>
 								</div>
 								...
 								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
 									...
 									'options'=>$category,'selected'=>$edit_gift['GiftCard']['category_id']));?>
 								</div>-->
 								<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 boxesstyle">Description</div>
 								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
 									<?php echo $this->Form->input('description', array('type'=>'textarea','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Description','value'=>$edit_gift['GiftCard']['description']));?>
 								</div>
 								...
 								<center>
 								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:15px;"><input type="submit" class="btn btn-default savebtn" style="background-color:#AB1A1F;color:#fff; !important;" value="Update Gift Card">
