...
<section id="main-content">
 	<section class="wrapper">
 		<div style="padding-top:20px" class="row">
          ...
          <li><a href="<?php echo HTTP_ROOT."/Admins/manageVendor";?>">Manage Vendor</a></li>
 					<li>Edit Vendor Profile</li>
 				</ol>
 			</div>
 		</div>
 		...
 		<div class="row">
 			<div class="col-md-12">
 				<div class="panel panel-default panel-primary">
 					<div class="panel-heading pannel-heading-strip"><i class="fa fa-edit"></i>&nbsp; Edit Vendor Profile</div>
 					<div class="panel-body">
 							...
 							<div class="login-wrap" style="padding:0;margin:0px auto;">
 								...
 								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
 									<?php echo $this->Form->input('first_name', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Name','id'=>'name','value'=>$edit_profile['UserMaster']['first_name']));?>
 								</div>
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 boxesstyle">Institution</div>
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                  <?php echo $this->Form->input('institute_name', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Group Name','value'=>$edit_profile['UserMaster']['institute_name']));?>
                </div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 boxesstyle">Registration Id</div>
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                  <?php echo $this->Form->input('official_reg_id', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Registration Id','value'=>$edit_profile['UserMaster']['official_reg_id']));?>
                </div>
                 <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 boxesstyle">Expertise Area</div>
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                  <?php echo $this->Form->input('area_of_expertise', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Expertise Area','value'=>$edit_profile['UserMaster']['area_of_expertise']));?>
                </div>
                 <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 boxesstyle">Address</div>
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                  <?php echo $this->Form->input('address', array('type'=>'textarea','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Address','value'=>$edit_profile['UserMaster']['address']));?>
                </div>
                 <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 boxesstyle">Description</div>
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                  <?php echo $this->Form->input('description', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Description','value'=>$edit_profile['UserMaster']['description']));?>
                </div>
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 boxesstyle">Teaching Experience</div>
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                  <?php echo $this->Form->input('coaching_experience', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Teaching Experience','value'=>$edit_profile['UserMaster']['coaching_experience']));?>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1">
                      <?php 
                       ...
                       if($pic=='http'){?>
                                  ...
                                  <?php }else{?>
                                  <img src="<?php echo HTTP_ROOT."/img/Vendor/profile/".$edit_profile['UserMaster']['profile_image'];?>" width="100" height="80" style="margin-top:10px;">
                                <?php }?>
                                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8"> 
                  <?php echo $this->Form->input('profile_image1', array('type'=>'file','label' => false,'div'=>false, 'class' => 'form-control boxesstyle'));?>
 								...
 								<center>
 								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:15px;"><input type="submit" class="btn btn-default savebtn" style="background-color:#AB1A1F;color:#fff; !important;" id="submit" value="Update Group">
