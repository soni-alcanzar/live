        ...
        <div class="row">
            <div class="col-md-12" style="padding-top:15px">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Manage Gift Card</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="dashboard-main">
                    <div class="panel panel-default panel-primary ">
                        <div class="panel-heading strip pannel-heading-strip"><i class="fa fa-gift"></i>&nbsp; Manage Gift Card</div>
                        <div class="panel-body">
                            <div class="table-top-action">
                                <div class="row">
                                    <div class="col-md-10">
                                        <?php echo $this->Html->link('Add Gift Card', array('controller'=>'Admins','action'=>'addGiftCard'), array('class'=>'btn btn-addnew','style'=>'background-color:#AB1A1F;color:#fff;'))  ?>
                                    </div>
                            ...
                            <table id="example" class="table table-striped table-bordered" style="table-layout: fixed;width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td><?php if($res['GiftCard']['card_type_status']=='1'){
                                         echo "Individual";
                                    }
                                    else if($res['GiftCard']['card_type_status']=='2'){
                                         echo "Corporation";
                                    }
                                    else{
                                         echo "N/A";
                            ...
                            <img src="<?php echo HTTP_ROOT."/img/gift_class/".$res['GiftCard']['gift_image'];?>" width="60" height="60">
                                     <?php }else{
                                       echo "N/A";
                                     }?></td> 
                                    ...
                                    ?></td>
                                    <td><?php 
                                       echo $this->Html->link('Edit',array('controller'=>'Admins','action'=>'editGiftCard/'.base64_encode($res['GiftCard']['id'])))."&nbsp;|&nbsp;";
