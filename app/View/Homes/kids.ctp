        ...
        <!-- end slider 1 -->
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 tab_head sr_2605_03_padding nav nav-tabs list_220 padd_l_r" style="">
            <div class="col-xs-12 col-sm-12 sr_2605_03_padding padd_l_r">
              <div class="col-md-2 col-sm-2 col-xs-3 rec-kids padd_l_r one_seg12">
                Kids & Teens
              </div>
              <div class="col-md-10 col-sm-10 col-xs-9 sr_2605_03_padding  sr_2705_bdr3 one_seg12 padd_l_r">
                    <div class="row">
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two_seg" >
                        <a href="#arts" >Abacus & Vedic Mathematics</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two_seg">
                    ...
                    <div class="row seg_brd_tp">
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two_seg">
                        <a href="#">Brain Efficiency</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two_seg">
                        <a href="#">Parenting</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two_seg">
                        <a href="#">Special Kids</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r three_seg">
