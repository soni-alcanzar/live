									 ...
									 <div class="col-sm-6 col-xs-6 col-md-6">
						                ...
						                <div class="col-sm-12 col-xs-12 sr_pv_padding_lr">
						                	...
						                	<div class="col-sm-12 col-xs-12 col-md-6">
						                		<div class="col-sm-12 col-xs-12" style="">
							                		<div class="form-group" style="margin-bottom: 5px;">
														<select  class="form-control reg_input" id="city_id" name="time_1">
															<option value="">Choose Time</option>
															<option value="Time (09:00 AM to 09:00 AM)">Time (09:00 AM to 10:00 AM)</option>
															<option value="Time (09:00 AM to 09:00 AM)">Time (11:00 AM to 12:00 PM)</option>
															<option value="Time (09:00 AM to 09:00 AM)">Time (01:00 PM to 02:00 AM)</option>
															<option value="Time (09:00 AM to 09:00 AM)">Time (03:00 PM to 04:00 PM)</option>
														</select>							
										...
										<div class="col-sm-12 col-xs-12 sr_pv_padding_lr">
						                	<a href="#" type="botton" class="btn btn-primary pc_sub_class" id="sub_class" style="float: right; margin-right: 30px; margin-bottom: 15px;" onclick="next_session('2');">Add Session 2</a>
						                </div>
										</div>
					                </div>
						                		...
						                		<div class="col-sm-12 col-xs-12" style="">
							                		<div class="form-group" style="margin-bottom: 5px;">
														<select  class="form-control reg_input" id="city_id">
															...
															<option value="3">Recurring Classes (Regular)</option>
															<option value="2">Recurring Classes (lrregular)</option>
														</select>							
