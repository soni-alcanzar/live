		...
		<div class="container ">	
				...
				<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 b_1_field">
					<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
                        ...
                        <div class="form-group">
                            <select id="locality_id" name="locality_id" class="form-control reg_input"  value="" data-actions-box="true">
                           <?php 
						...
						<div class="form-group ">
                            ...
                            <select id="category_id" name="category_id[]" class="form-control reg_input" multiple="multiple" value="" data-actions-box="true">
                           <?php 
                                foreach ($category as $key => $category_value) {
                               ?>
                                <option value="<?php echo $category_value; ?>"><?php echo $category_value; ?></option>
                                <?php
                            }
                            ?>
                        </select>
							<?php //cho $this->Form->input('category_id', array('type'=>'select','label' => false,'div'=>false, 'class' => 'form-control reg_input','id'=>'category_id','options'=>$category,'option_selected'=>$category['1']));?>
