...
$class_id          = $view_class['VendorClasse']['id'];
...
<div class="col-md-10 col-sm-9 col-xs-12 ruth6542 ruth654786 cstm_md9">
    ...
    <!-- <input type="hidden" name="class_id" id="class_id" value=""/> -->
		...
		<div class="col-md-12 col-sm-12 col-xs-12 padd_l_r book-form-ticket">
				<div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 col-xs-12 book-no">
					...
					<div class="col-md-5 col-sm-5 col-xs-5 padd_l_r">
						...
						<input type="hidden" id="max_price" value="<?php echo $price_per_head; ?>">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 padd_l_r book-form-field">
				<div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 col-xs-12">
					...
					<div class="form-group">
					  <div class="col-md-12 col-sm-12 col-xs-12 book-rupee">
					  	...
					  	<span class="book-total" id="tp_rs"> Total Price: Rs. 0.00/- </span>
					  </div>
					</div>
					</div>
					</div>
				...
				<!-- Start For Pey -->
					...
					?>
						<form action="<?php echo $action; ?>" method="post" name="payuForm">
							  ...
							  <input type="hidden" name="firstname" id="firstname" value="Rohit" />
							  <input type="hidden" name="email" id="email" value="thirdeyecreations2015@gmail.com" />
							  <input type="hidden" name="phone" id="phone" value="7338793542"/>
							  <textarea name="productinfo" id="productinfo" style="display:none;">Yoga class</textarea>
							  <input type="hidden" name="surl" id="surl" value="<?php echo HTTP_ROOT; ?>/Homes/paySuccess" size="64" />
              ...
              <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 col-xs-offset-2 col-xs-8 book-proceed cust-xs-offset-2">
                <center><button id="pay" class="btn book-pr-pay">Confirm</button></center>
               </div>
						</div>
					<!-- End Pay -->
			<!-- End -->
