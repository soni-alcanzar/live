...
<div class="container-fluid padd_l_r">
	...
	<!-- **********whole body**************** -->
            ...
            <div id="organization">
              ...
              <div class="form-group">
                  <label for="usr">&nbsp;</label>
                  <?php echo $this->Form->input('registration_id', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control reg_input','id'=>'registration_id','placeholder'=>'Institute Official Registration Id'));?>
            ...
            <div class="form-group reg_text123">
              ...
              <div class="reg2_expert_area">like Hatha Yoga expert, Karata Black Belt Holder, 6 sigma expert etc</div>
              ...
              <?php echo $this->Form->input('address', array('type'=>'textarea','label' => false,'div'=>false, 'class' => 'form-control reg_input','id'=>'address','placeholder'=>'Full Address','rows'=>3));?>
               ...
               <?php echo $this->Form->input('description', array('type'=>'textarea','label' => false,'div'=>false, 'class' => 'form-control reg_input','id'=>'description','placeholder'=>'About Yourself','rows'=>3));?>
                  ...
                  <div class="pull-right">
                    <!-- <a href="<?php //echo HTTP_ROOT;?>/Homes/reg3">
                      <button class="btn br_login1">Skip</button>
                    </a> -->
                     <a href="#" class="btn br_login1" onclick="skip();">Skip<i class="bangl fa fa-angle-right" aria-hidden="true"></a>

                    <!-- <a href="<?php //echo HTTP_ROOT;?>/Homes/reg3">Skip</a> -->
...
function skip()
{
  ...
  window.location.assign("<?php echo HTTP_ROOT;?>/Homes/reg3/"+skip_val)
}
...
function back()
{
  ...
  window.location.assign("<?php echo HTTP_ROOT;?>/Homes/reg1/"+skip_val)
}
</script>