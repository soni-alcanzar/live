...
<div class="col-md-12 col-sm-12 col-xs-12 padd_l_r">
  <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r">
    <a href="http://braingroom.com/braingroom/homes/informative">
        ...
        <!-- end slider 1 -->
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 tab_head sr_2605_03_padding nav nav-tabs list_220 padd_l_r" style="">
            <div class="col-xs-12 col-sm-12 sr_2605_03_padding padd_l_r">
              <div class="col-md-2 col-sm-2 col-xs-3 rec_infr padd_l_r one_seg12">
                Informative & Motivational
              </div>
              <div class="col-md-10 col-sm-10 col-xs-9 sr_2605_03_padding  sr_2705_bdr3 one_seg12 padd_l_r">
                    <!-- <ul class=" list-inline br_ul">
                      <li class="list-group-item">Cooking & Baking</li>
                      <li class="list-group-item">Arts & Crafts</li>
                      <li class="list-group-item">Music & Dance</li>
                      <li class="list-group-item">Sports</li>
                      <li class="list-group-item">Photography</li>
                      <li class="list-group-item">Adventure Activities</li>
                      <li class="list-group-item">Media & Literature</li>
                      <li class="list-group-item">Self Defence</li>
                    </ul> -->
                    <!-- <div class="one_seg">Cooking & Baking</div>
                    <div class="one_seg">Arts & Crafts</div>
                    <div class="one_seg">Music & Dance</div>
                    <div class="one_seg">Sports</div>
                    <div class="one_seg">Photography</div>
                    <div class="one_seg">Adventure Activities</div>
                    <div class="one_seg">Media & Literature</div>
                    <div class="one_seg">Self Defence</div> -->
                    <div class="row">
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two-seg">
                        <a href="#">Personality Development</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two-seg" >
                        <a href="#arts" >Communication & Soft Skills</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two-seg">
                        <a href="#">Brain Efficiency Improvement</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r three-seg">
                        <a href="#">Language Learning</a>
                      </div>
                    </div>
                    <div class="row seg_brd_tp">
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two-seg">
                        <a href="#">Motivational Task</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two-seg">
                        <a href="#">Spiritual Talks</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two-seg">
                        <a href="#">Career Management</a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r three-seg">
                        <a href="#">Relationship Management</a>
                      </div>
                      <!-- <div class="col-md-2 col-sm-2 col-xs-2 padd_l_r two_seg">India Indigenous</div> -->
                    </div>
                    <div class="row seg_brd_tp">
                      <div class="col-md-3 col-sm-3 col-xs-2 padd_l_r two-seg">
