			...
			<!-- <div class="col-md-12 col-sm-12 b_1_body"> -->
				...
				<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 b_1_field">
					...
					<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
						...
						<p class="mbno">Enter Mobile Number to Get Started </p>
						<!-- ***************select field 1************** -->
						<div class="form-group b_exprt">
							<p class="abc">
                               <?php echo  $this->Session->flash(); ?>
                             </p>
							<input class="form-control reg_input" id="usr" placeholder="Mobile Number" name="mobile_no" type="text" maxlength="10">
						</div>
						<!-- ***************select field 1************** -->
						<!-- **************button************* -->
                  ...
                  <div class="pull-left">
                    <button class="btn br_login12">Send Code</button></a>
                  </div>
                  <div class="pull-right">
                    <!-- <a href="#"><button class="btn br_login1">Skip</button></a> -->
  							    <a href="#"><button class="btn br_cncl2">Cancel</button></a>
                  </div>
							  </div>
