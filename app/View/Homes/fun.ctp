                          ...
                          <div class="col-md-8 col-sm-8 col-xs-12 text_res sr_2605_03_padding">
                             <div class="col-xs-12 col-sm-12 sr_2605_06 sr_2605_06_textLorem021">
                                ...
                                <div class="hathyga up-com-post col-xs-12 col-sm-12 sr_2605_03_padding upcoming-class-title">
                                    <span class="city"> <strong> <?php echo $class_topic; ?> </strong> </span>
                                </div>

                                <div class="col-xs-12 col-sm-12 sr_2605_03_padding sr_serch_div_l_hite sr_class_acc_div padd_l_r" style="margin-bottom:7px;">
                                    <div class="row">
                                      <div class="col-md-2 col-sm-2 col-xs-2 upcom-img-class_fun_update">
                                      ...
                                      <span class="city">  <?php echo $allclass_value['bg_vendor_classes']['location'];?> </span>
                                      </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 sr_2605_03_padding sr_serch_div_l_hite sr_class_acc_div padd_l_r"
                                  ...
                                  <div class="row">
                                   ...
                                   <span class="city">
                                    <strong> By :</strong> 
                                    <?php echo ucfirst($allclass_value['bg_user_masters']['first_name']);?>
                                   </span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 sr_2605_03_padding sr_serch_div_l_hite sr_class_acc_div padd_l_r" 
                                  style="margin-bottom:7px;">
                                    <div class="row">
                                      ...
                                      <div class="col-md-10 col-sm-10 col-xs-10 sr_class_acc_text02 upclass-location">
                                        <span class="city"> <strong><?php echo ucfirst($allclass_value['bg_vendor_classes']['no_of_session']);?></strong>&nbsp;Session </span>
                                      </div>
                                    </div>
                                </div>
                                      ...
                                      <div class="col-md-2 col-sm-2 col-xs-2 upcom-img-class_fun_update">
                                        ...
                                        <div class="col-md-10 col-sm-10 col-xs-10 sr_class_acc_text02 up-com-post-text upclass-location">
                                          ...
                                          <span class="city">
                                            ...
                                            <?php  if(strlen($allclass_value['bg_vendor_classes']['class_summary']) < 150 ){ ?>

                                                 <?php echo $allclass_value['bg_vendor_classes']['class_summary']; ?>
                                ...
                                <div class="col-xs-12 col-sm-12 padd_l_r">
                                    ...
                                    <?php for($i=0;$i<5;$i++){ ?> 
                                      <i class="fa fa-star-o" style="font-size:18px;color:#00487b" aria-hidden="true"></i>
                                    <?php } ?> 
                    ...
                    <div class="row">
                      <div class="C_17_num flex-index-slider">
                        <div id="grid-contant-slider2" class="b_sld">
                          <?php 
                              foreach($recomendeds_status as $result) { 
