         ...
         <div class="col-md-12 col-sm-12 col-xs-12 clrdash123 ruth1">
            <div class="col-md-5 col-sm-5 col-xs-12 bar321 bar786">
                <div>
                    ...
                    <span class="dashbrd12 prf543">Payment Tracking Fixed Classes </span>
                </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 " style="overflow-x:auto;">
                <table class="table flex_page_tb12 datatable">
                    ...
                    <tbody>
                        <?php 
                            if($count > 0){
                            $i=1; foreach ($flexible_data as $value) { ?>    
                            <tr>   
                                ...
                                <td>
                                    <a style="color:blue;" href="<?php echo HTTP_ROOT;?>/Homes/payTrackFlexibleDetail/<?php echo base64_encode($value['VendorClasse']['id'])?>">Booking Details </a>    
                                </td>
                            </tr>
                       <?php $i++; } }else{?>
                            <tr>   
