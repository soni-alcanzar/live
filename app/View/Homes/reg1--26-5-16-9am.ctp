		...
		<div class="container ">	
				...
				<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 b_1_field">
					<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
                        ...
                        <div class="form-group">
                            <select id="locality_id" name="locality_id[]" class="form-control reg_input" multiple="multiple" value="" data-actions-box="true"  style='overflow:auto'>
                           <?php 
...
var last_valid_selection = null;
      $('#locality_id').change(function(event) {
