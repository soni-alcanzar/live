...
<div class="col-md-10 col-sm-9 col-xs-12 ruth6542 ruth654786">
    <div class="col-md-12 col-sm-12 col-xs-12 sr_pv_padding_lr" style="background:#fff;">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r add_top_13a">
            <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r weight_brd">
                <div class="col-md-8 col-sm-7 col-xs-12">
                    <p class="weight_loss">Hath Yoga for Weight Loss in 10 Days</p>
                </div>
                <div class="col-md-4 col-sm-5 col-xs-12 padd_thirty">
                    <div class="pull-right Harrington">
                        <div class="col-md-2 col-sm-1 col-xs-2">
                            <i class="fa fa-user user_fa" aria-hidden="true"></i>
                        </div>
                        <div class="col-md-10 col-sm-10 col-xs-10">
                            <p class="kim">By Kim Harrington</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r">
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="col-md-12 col-sm-12 col-xs-12 star_class padd_thirty">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 padd_thirty">
                       <div class="col-md-8 col-sm-8 col-xs-6 padd_l_r">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6 padd_thirty">
                            <div class="pull-right">
                                <div class="col-md-4 col-sm-4 col-xs-4 pad_fixed">
                                     <?php echo $this->Html->image('icon_fixed.png', array('alt' => 'CakePHP','class'=>'fixed_class'));?>
                                </div>
                                <div class="col-md-8 col-sm-8 col-xs-8 fixed_txt">
                                    Fixed Class
                                </div>
                            </div>
                        </div> 
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r">
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 padd_thirty">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 webnair">
                                    <div class="col-md-1 col-sm-1 col-xs-2 wenair">
                                        <?php echo $this->Html->image('icon_webnair.png', array('alt' => 'CakePHP','class'=>'fixed_class'));?>
                                    </div>  
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 padd_thirty br_desc">
                            <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r desc_clr">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 fee_incld">
                                    ...
                                    <p>Duration</p>
                                    <ul>
                                      <li>1 hr 15min per day(5-session) or</li>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 find_people join_class">
                            <div class="col-md-6 col-sm-6 col-xs-6 people_aricon">
                                <div class="col-md-12 col-sm-12 col-xs-12 people_around">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 around_p padd_l_r">
                                        Find People around you who are attending this class
                                    </div>
                                </div>    
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-6 people_aricon1">
                                <div class="col-md-12 col-sm-12 col-xs-12 people_book">
                                    <div class="col-md-2 col-sm-2 col-xs-2 globe">
                                        <?php echo $this->Html->image('btnicon2.png', array('alt' => 'CakePHP','class'=>'fixed_class1'));?> 
                                    </div>
                                    <div class="col-md-10 col-sm-10 col-xs-10 around_p padd_l_r">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 rs_fty">
                    <div class="col-md-12 col-sm-12 col-xs-12 book_1500">
                        <div class="col-sm-12 col-xs-6 fifhndrd"><h3>&#8377;1500</h3></div>
                        <div class="col-sm-12 col-xs-6 book_center"><button class="btn book_now">Book Now</button></div>
                        <div class="col-md-12 col-sm-12 col-xs-12 padisplay">
                            ...
                            <div class="col-md-8 col-sm-9 col-xs-10 begin_lm">
                                Beginners
                            </div>
                        </div>      
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 padisplay1">
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12 padisplay1">
                            ...
                            <div class="col-md-10 col-sm-9 col-xs-10 begin_lm">
                                15 to 17Yrs Age Group
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12 padisplay1">
                            <div class="col-md-12 col-sm-12 col-xs-12 pad_fb">
                                                ...
                                                <div class="view1 view-first">
                                                    <div class="index_img">
                                                        ...
                                                        <?php echo $this->Html->image('pics9.png', array('alt' => 'CakePHP'));?>
                                                            <button class="btn butt_dollar_br">&#x20B9;320</button>
                                                    </div>                 
                                                </div>                           
                                                <div class="golden_br13">
