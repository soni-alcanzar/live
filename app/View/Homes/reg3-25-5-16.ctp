	...
	<!-- **********whole body**************** -->
            ...
            <?php echo $this->Form->create('UserMaster',array('enctype'=>'multipart/form-data'));?>
              <p class="abc">
                  ...
                  <label for="usr">&nbsp;</label>
                   <?php echo $this->Form->input('coaching_experience', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control reg_input','id'=>'coaching_experience','placeholder'=>'Teaching Experience'));?>
