            ...
            <div class="col-xs-12 col-sm-12 pad_all">            
                ...
                <div class="row">
                	<div class="col-xs-12 col-sm-12 col-md-12 pad_all">
                      ...
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Parents & Kids.png" alt="images not found"  class="community1">									                      </a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/2">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Study Groups.png" alt="images not found"  class="community">
                      </a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/3">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Hobby Groups.png" alt="images not found"  class="community">
                      </a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/4">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Fitness Groups.png" alt="images not found" class="community cc xx" >
                      </a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/9">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Residential Community.png" alt="images not found" class="community aa"></a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/10">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Senior Citizens.png" alt="images not found" class="community">
                      </a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/11">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Kids Gangs.png" alt="images not found"  class="community2">
                      </a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/12">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Peers & Colleagues.png" alt="images not found" class="community aa1"></a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/5">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Ladies Club.png" alt="images not found" class="community zz">
                      </a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/6">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Pack of Men.png" alt="images not found" class="community cc">
                      </a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/7">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Friends Gangs.png" alt="images not found" class="community">
                      </a>
                      <a href="<?php echo HTTP_ROOT;?>/Homes/community/8">
                      <img src="<?php echo HTTP_ROOT;?>/img/community-groups/Couples.png" alt="images not found" class="community zz1">
                      </a>
                    </div>
