			...
			<!-- <div class="col-md-12 col-sm-12 b_1_body"> -->
				...
				<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 b_1_field">
					<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
						...
						<?php echo $this->Form->create('verifyOtp');?>
						<div style="color:red;text-align:center;">
 									<?php echo  $this->Session->flash(); ?>
 								</div>
						<!-- ***************select field 1************** -->
						<div class="form-group b_exprt">
							<input class="form-control reg_input" id="usr" name="otp_code" placeholder="Enter Your Code" type="text">
						</div>
						<!-- ***************select field 1************** -->
						<!-- **************button************* -->
                  ...
                  <div class="pull-left">
                    <button type="submit" class="btn br_cnch">Reset Password </button>
                  </div>
