                        ...
                        <div class="form-group col-xs-12 padd_l_r"> 
                          ...
                          <div class="form-group" style="float:left !important;">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12 blogin1 sr_18_07_login_padding03">
                                <a href="#">
                                    <img src="<?php echo HTTP_ROOT;?>/img/img/facebookl_btn.jpg" onclick="return fb_login();" class="img-responsive sr_18_07_login_img_fb02">
                                </a>
                            </div>
                          ...
                          <div class="form-group">        
                              ...
                              <div class="col-md-4 col-sm-12 col-xs-12 frg2 padd_l_r b_widh">
                                  <a href="<?php echo HTTP_ROOT;?>/homes/sendOtp" class="pull-right capitalize">Forgot Password</a>
                              </div>
                          </div>
                          <!-- **************forget password****** -->
                      </div>
