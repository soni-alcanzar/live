	        ...
	        <div class="modal-body">
	            <div class="col-sm-12 col-xs-12" style="margin-top: 20px;">
	            	<div class="col-sm-12 col-xs-12 col-md-6">
			            ...
			            <div class="col-sm-12 col-xs-12">
	                		<div class="form-group br_state" style="margin-bottom: 10px;">
	                			<input class="form-control reg_input" placeholder="No. of session in a Single Class(X)" id="session_single_class" name="session_single_class" type="text">	
								<p class="err_css" id="error_mobile" style="padding-left: 10px; padding-top: 20px; margin-bottom: 5px;"></p>
			                </div> 
			            </div> 
			        </div> 
	            	 ...
	            	 <div class="col-sm-12 col-xs-12 " style="">
		                ...
		                <div class="col-sm-12 col-xs-12 sr_pv_padding_lr">
		                	<div class="col-sm-12 col-xs-12 col-md-6">
		                		<div class="col-sm-12 col-xs-12" style="">
			                		...
			                		<div class="form-group" style="margin-bottom: 15px;">
			                			<select  class="form-control reg_input" id="date_of_week" name="date_of_week">
		                	...
		                	<div class="col-sm-12 col-xs-12 col-md-6">
		                		<div class="col-sm-12 col-xs-12" style="">
			                		<div class="form-group" style="margin-bottom: 5px;">
											<select  class="form-control reg_input" id="time_of_day" name="time_of_day">
		                ...
		                <div class="col-sm-12 col-xs-12 sr_pv_padding_lr">
		                	<button  class="btn btn-primary pc_sub_class" id="" style="float: right; margin-right: 30px; margin-bottom: 15px;" onclick="save_regular();">Add Session</button>
		                </div>
		            </div>	
	            </div>
	            <div class="col-sm-12 col-xs-12">
