                ...
                <div class="col-md-8 col-sm-8 col-xs-8 starruth">
                  <div class="elemnt">
                   <?php if($user_view['UserMaster']['user_type_id']=='1'){?> 
                    ...
                    <span class="prf-bg"><img src="<?php echo HTTP_ROOT;?>/img/Vendor/profile/<?php echo $user_view['UserMaster']['profile_image'];?>" class="rth321 prflimg" ></span>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r" id="profile1" style="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r myprflbrd" id="photo2">
                    <div class="col-md-12 col-sm-12 col-xs-12 bgsec">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-6 photos1" id="vid"><i class="fa fa-minus pull-right" aria-hidden="true"></i></div>
                     ...
                     <?php if(($user_view['UserMaster']['user_type_id'])=='1'){?>
                        <!-- ======== Start of Vendor Profile ========================== -->
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12 bgsec">
                            ...
                            <div class="col-md-9 col-sm-8 col-xs-6 photos1" id="vid"><i class="fa fa-minus pull-right" aria-hidden="true"></i></div>
                            <div class="col-md-9 col-sm-8 col-xs-6 photos1" style="display:none;" id="vid"><i class="fa fa-plus pull-right" aria-hidden="true"></i></div>
                          </div>
                          <!-- *****************section 3************* -->
                          <!-- *****************Teaching Experience************** -->
                          <div class="col-md-12 col-sm-12 col-xs-12 detail">
                                                        ...
                                                        <div class="col-md-10 col-sm-10 col-xs-10 upclass-location">
                                                          <div class="row">
                                                            ...
                                                            <div class="col-md-7 col-sm-7 col-xs-6 past-timmg-div-second">
                                                              ...
                                                              <div class="col-md-10 col-sm-10 col-xs-10 sr_class_acc_text02 upclass-location">9am to 5pm</div>
                                                            </div>
                                                          </div>
                                                        </div>
                                                      </div>
                                                   ...
                                                   <div class="col-xs-12 col-sm-12 sr_2605_06 sr_2605_06_textLorem021 sr_pv_padding_lr txt_cntnt">
                                                      ...
                                                      <div class="col-xs-12 col-sm-12 col-md-12 sr_2605_03_padding sr_serch_div_l_hite sr_class_acc_div padd_l_r">
                                                        <div class="row">
                                                          ...
                                                          <div class="col-md-10 col-sm-10 col-xs-10   sr_class_acc_text02 upclass-location">Chennai
                                                          </div>
                                                        </div>
                                                      </div>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r lernr-class" style="margin-top: 3px;">
                            <div class="upcomming-divv upcomming-divv1 panel-group col-xs-12 sr_pv_padding_lr padd_l_r" id="accordion1" style="">                            
                                                 ...
                                                 <div class="col-xs-12 col-sm-12 sr_2605_06 sr_2605_06_textLorem021 sr_pv_padding_lr txt_cntnt">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 sr_2605_03_padding sr_serch_div_l_hite sr_class_acc_div padd_l_r">
                                                      <div class="row">
                                                        ...
                                                        <div class="col-md-10 col-sm-10 col-xs-10   sr_class_acc_text02 upclass-location">Chennai</div>
                                                      </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-12 col-md-12 sr_serch_div_l_hite sr_class_acc_div padd_l_r">
                                                      <div class="row">
                              ...
                              <div class="past-tab">
                                ...
                                <div class="panel-heading col-xs-12 sr_class_acc01">
                                    <div class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapsefour"  style="padding: 0px;">
                                          <span class="sr_class_acc01 sr_class_acc_text1" style="box-sizing:none;float:left;">Past Classes</span>
                                          <span class="sr_class_acc_icon"><i class="fa fa-plus" aria-hidden="true" style="float:right">&nbsp;</i></span>
                                        </a>
                                    </div>
                                </div>
                                <div id="collapsefour" class="panel-collapse collapse col-xs-12 sr_pv_padding_lr myprflbrd">
                                    <div class="panel-body jstify col-xs-12 sr_pv_padding_lr">
                                      <div class="col-xs-12 col-sm-12 sr_2605_03_padding sr_pv_padding_lr" id="#">
                                        <?php if(!empty($past_class)){
                                          foreach ($past_class as $result) {
                                          ...
                                          <div class="col-sm-12 col-xs-12 sr_260501 sr_pv_padding_lr" style="padding-bottom: 15px; border-bottom: 2px solid #00477b; background:#fff;"> 
                                                ...
                                                <div class="col-md-6 col-sm-12 col-xs-12 text_res sr_2605_03_padding status-div">
                                                   <div class="col-xs-12 col-sm-12 sr_2605_06 sr_2605_06_textLorem021 sr_pv_padding_lr txt_cntnt">
                                                      ...
                                                      <!-- <div class="col-xs-12 col-sm-12 padd_l_r"><img src="<?php echo HTTP_ROOT;?>/img/8.jpg" class="star" style="height: 25px;"></div>
                                                      <div class="col-xs-12 col-sm-12" style="text-align: right;padding-right:0px;"><button class="booking">&&</button></div> -->
                                                    </div>
                                                </div>        
                                                <!-- ********text************ -->
                                          </div> 
                                    ...
                                    <div class="col-sm-12 col-xs-12 sr_260501 sr_pv_padding_lr" style="padding-bottom: 15px; border-bottom: 2px solid #00477b; background:#fff;"> 
                                          ...
                                          <div class="col-md-7 col-sm-12 col-xs-12 text_res sr_2605_03_padding">
                                             <div class="col-xs-12 col-sm-12 sr_2605_06 sr_2605_06_textLorem021 sr_pv_padding_lr txt_cntnt">
                                                ...
                                                <div class="col-xs-12 col-sm-12 padd_l_r"><img src="<?php echo HTTP_ROOT;?>/img/8.jpg" class="star" style="height: 25px;"></div>
                                                <!-- <div class="col-xs-12 col-sm-12" style="text-align: right;padding-right:151px;"><button class="booking">&&</button></div> -->
                                              </div>
                                          </div>        
                                          <!-- ********text************ -->
                                    </div> 
