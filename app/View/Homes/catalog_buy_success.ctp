        ...
        <div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-3 col-md-6 ">
            ...
            <div class="col-xs-12 col-sm-12 sr_03_08_padding_git_s" style="border: 1px solid rgb(150, 148, 149); box-shadow: 7px 12px 22px rgb(172, 170, 171);"> 
                <div class="col-xs-12 col-sm-12" style="background: #2BCDC0; padding: 15px 0px 10px;">
                   <span class="success_sr_03_08"><center>Booking Success</center></span>               
                </div> 
                <div class="col-xs-12 col-sm-12 " style="">&nbsp;</div>
                <div class="col-xs-12 col-sm-12 " style="">&nbsp;</div> 
                <div class="col-xs-12 col-sm-12 " style="">
                    <div class="col-xs-12 col-sm-12">
                        <center><span class="booking_id_sr_03_08">Your Transaction has been Successfully.</span></center>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 " style="">
                    <center>
                        <img src="<?php echo HTTP_ROOT;?>/img/gift_image/g_fb.png" 
                        class="common_img_css" alt="img" onclick="postToFeed(); return false;">
                        <a class="twitter popup toptrailertwitter" href="http://twitter.com/share?text=<?php echo $text_msg; ?>">
                            <img src="<?php echo HTTP_ROOT;?>/img/gift_image/g_tw.png" class="common_img_css" alt="img"></a> 
...
<script> 
      ...
      FB.init({appId: "289468021432742", status: true, cookie: true}); // calling the API ...
        var obj = {
          method: 'feed',
          redirect_uri:'https://www.facebook.com/cryswashington?fref=ts',
          link:'http://www.braingroom.com/',
          picture: '<?php echo $class_img; ?>',
          name: 'Hi <?php if($firstname==""){ echo xyz;} else { echo $firstname; }; ?>',
          caption: '<?php echo $book_id; ?>',
          description: '<?php echo $text_msg; ?>'
        };
