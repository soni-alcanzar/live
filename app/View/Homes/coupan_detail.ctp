...
<div class="container-fluid sr_03_08_padding_git_s">
    <div class="col-xs-12 col-sm-12 sr_03_08_padding_git_s sr_03_08_g_">
        <div class="col-xs-12 col-sm-12 col-md-offset-1 col-md-10 padd_l_r">
            <span class="g_status_sr_03_08"><b>Coupan Details</b></span>
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-3 col-md-6 ">
            ...
            <div class="col-xs-12 col-sm-12 sr_03_08_padding_git_s" style="border: 1px solid rgb(150, 148, 149); box-shadow: 7px 12px 22px rgb(172, 170, 171);"> 
                <div class="col-xs-12 col-sm-12" style="background: #2BCDC0; padding: 15px 0px 10px;">
                   <span class="success_sr_03_08"><center>Booking Status</center></span>               
                </div> 
                <div class="col-xs-12 col-sm-12 " style="">&nbsp;</div>
                <div class="col-xs-12 col-sm-12 " style="">&nbsp;</div> 
                <div class="col-xs-12 col-sm-12 " style="">
                    <div class="col-xs-12 col-sm-12">
                <center><span class="booking_id_sr_03_08">Your Class has been Booked Successfully</span>
                            <?php

                            $rupees           = $coupan_Detail[0]['GiftCupan']['rupees'];
                            $available_rupees = $coupan_Detail[0]['GiftCupan']['available_amt'];
                            $class_topic      = $gift_vendor_classe[0]['VendorClasse']['class_topic'];
                 ...
                 <div class="col-xs-12 col-sm-12 " style="">
                    <div class="col-xs-12 col-sm-5 col-md-5 sr_03_08_d_div01">
                        <span class="booking_id_sr_03_08">Category name:</span>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-7 sr_03_08_d_div02">
                        <span class="booking_text_sr_03_08"><?php echo $category; ?></span>
                    </div> 
                </div>
                 <div class="col-xs-12 col-sm-12 " style="">
                    <div class="col-xs-12 col-sm-5 col-md-5 sr_03_08_d_div01">
                        <span class="booking_id_sr_03_08">Class name:</span>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-7 sr_03_08_d_div02">
                        <span class="booking_text_sr_03_08"><?php echo $class_topic; ?></span>
                    </div> 
                </div>
                <div class="col-xs-12 col-sm-12 " style="">
                    <div class="col-xs-12 col-sm-5 col-md-5 sr_03_08_d_div01">
                        <span class="booking_id_sr_03_08">Amount deducted from coupon:</span>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-7 sr_03_08_d_div02">
                        <span class="booking_text_sr_03_08"><?PHP echo $deducted; ?></span>
                    </div> 
                </div>

                 <div class="col-xs-12 col-sm-12 " style="">
                    <div class="col-xs-12 col-sm-5 col-md-5 sr_03_08_d_div01">
                        <span class="booking_id_sr_03_08">Available amount in coupon:</span>
                    </div>
                    <div class="col-xs-12 col-sm-5 col-md-7 sr_03_08_d_div02">
                        <span class="booking_text_sr_03_08"><?PHP echo $available_rupees; ?></span>
                    </div> 
                ...
                <div class="col-xs-12 col-sm-12 " style="">
                   <!--  <center>
                        ...
                        <img src="<?php //echo HTTP_ROOT;?>/img/gift_image/g_in.png" class="common_img_css" alt="img">
                        <img src="<?php //echo HTTP_ROOT;?>/img/gift_image/mail.png" class="common_img_css" alt="img" id="mail">
                    </center>     -->
                </div>
                <div class="col-xs-12 col-sm-12 " style="">&nbsp;</div>
                <div class="col-xs-12 col-sm-12 " style="">&nbsp;</div>
