...
*/
                  ...
                  $class_starting_month     =   $allclass_value['VendorClasse']['starting_month'];
                  ...
                  $class_class_type_id      =   $allclass_value['VendorClasse']['class_type_id'];
                    ...
                    <div class="col-sm-12 col-xs-12 sr_260501 padd_l_r"> 
                          ...
                          <div class="col-md-4 col-sm-4 col-xs-12 img-responsive padd_l_r">
                            <div class="col-xs-12 col-sm-12 fun01_img_w">
                              ...
                              ?>
                              <a href="<?php echo HTTP_ROOT;?>/Homes/viewclassDetail/<?php echo $class_id; ?>"><img src="<?php echo HTTP_ROOT;?>/img/Vendor/class_image/<?php echo $upload_class_photo; ?>" class="img_res img-responsive img-thumbnail"></a>
                          ...
                          <div class="col-md-8 col-sm-8 col-xs-12 text_res sr_2605_03_padding">
                             <div class="col-xs-12 col-sm-12 sr_2605_06 sr_2605_06_textLorem021">
                                ...
                                <div class="col-xs-12 col-sm-12 sr_2605_03_padding sr_serch_div_l_hite">
                                  ...
                                  <span class="city br_time"><?php echo $class_starting_month; ?></span>&nbsp;
