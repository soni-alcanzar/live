                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r weight_brd class-title-div">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12" style="padding:0px; margin-top:10px;">
                            ...
                            <?php /* Modified by dinesh@braingroom.com 19/07/16*/?>
                                ...
                                id="<?php echo $detail['User']['id'];?>">By <?php echo $detail['User']['first_name']; ?></p>
                                <?php 
                                   
                                   if(!empty($detail['VendorClasse']['upload_class_photo']))
                                   {
                                    ?>
                                     <?php /*?><img src="<?php echo HTTP_ROOT;?>/img/Vendor/class_image/<?php echo $photo; ?>" id="profile-pic<?php echo $photo;?>" class="georgeimg prflimg pull-right profile-img"><?php */?> 
                                     <?php	echo $this->Image->resize('Vendor/class_image/'.$detail['VendorClasse']['upload_class_photo'].'.jpg','305','148', array('class' => 'imgresponsive img-thumbnail'));
											?>
                                     <?php
                                     }
                                     else
...
<?php 
                                   ...
                                   {
                                    ?>
                                     <?php	echo $this->Image->resize('Vendor/class_image/'.$detail['VendorClasse']['upload_class_photo'].'.jpg','305','148', array('class' => 'img-thumbnail'));
											?>
                                     <?php
                                     }
                                     else
                                     {
                                        ?>
                                        <img src="<?php echo HTTP_ROOT;?>/img/Vendor/class_image/defult_pic.png" id="defult_pic" class="img-thumbnail"> 
                                        <?php
                                    }
                                ...
                                ?>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 webnair">
                                            <div class="col-md-6 col-sm-6 col-xs-6 wenair">
                                                <span><?php echo $this->Html->image('icon_webnair.png', array('alt' => 'Class Type','class'=>'fixed_class'));?></span> <span>
                                      <?php
										 $class_typ =  explode(',',$detail['VendorClasse']['class_type_id']);
										  $type = '';
										  foreach($class_typ as $class_type){
											  	$res = $this->Layout->class_type($class_type);
											 $type=$type.",".$res['ClassType']['types'];
											  }
											  echo $type;
										  ?>          
                                           ...
                                           <?php if(!empty($detail['VendorClasse']['community_id'])){?>
                                            <div class="col-md-6 col-sm-6 col-xs-6 wenair">
                                                <span><?php echo $this->Html->image('kids_gang.png', array('alt' => 'CakePHP','class'=>'fixed_class'));?></span> <span>
                                                <?php
										 $comm =  explode(',',$detail['VendorClasse']['community_id']);
										  $com_val = '';
										  foreach($comm as $com){
											  	$res = $this->Layout->get_community($com);
											 $com_val=$com_val.",".$res['Community']['community_name'];
											  }
											  echo $com_val;
										  ?>   
                                                </span>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r desc_clr">
                                     <h4 style="font-size:25px;" class="butt_gft" align="center">Summary</h4>
                                        <div class="col-md-12 col-sm-12 col-xs-12 desc_cntnt clss-desc-content"  style=" margin-top:10px;">
                                            ...
                                            <p class="sum-p" style="height: auto ! important;"><?php 
											if(!empty($detail['VendorClasse']['class_summary'])){ 
												echo $detail['VendorClasse']['class_summary'];
											} 
                                            else { echo 'NA';} ?> </p>
                                     ...
                                     <h4 style="font-size:25px;" class="butt_gft" align="center">Class Provider</h4>
                                        <div class="col-md-12 col-sm-12 col-xs-12 desc_cntnt clss-desc-content"  style=" margin-top:10px;">
                                            ...
                                            <p class="sum-p" style="height: auto ! important;">
                                              <?php  if(!empty($detail['User']['yourself'])){ 
                                                echo $detail['User']['yourself'];
                                              }else 
                                                {  
                                                  echo 'NA'; 
                                                } 
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 rs_fty right-sidebar">
                            <div class="col-md-12 col-sm-12 col-xs-12 book_1500 right-book-first">
                                ...
                                if(@$sesstion_data['User']['user_type_id']==2){
                                  ...
                                  <?php
                                      ...
                                      else  if(@$sesstion_data['User']['id']==1){
                                ?>
                                  <div class="col-xs-12 col-sm-12 padd_l_r">
                                ...
                                <div class="col-xs-12 col-sm-12 padd_l_r get_quote_m_top22">
                                   ...
                                   <div class="col-md-12 col-sm-12 col-xs-12 padisplay1 ">
                                      ...
                                      <div class="col-md-8 col-sm-9 col-xs-10 begin_lm cust-md-padd right-bgin-content booknow-content">
                                          <span class="sum-chennai"><?php echo $detail['Locality']['name']; ?></span>
                                      </div>
                                    </div>
                                    <?php
                                        }
                                  ?>
                                  <?php if(!empty($detail['VendorClasseLocationDetail'])){?>
                                   <div class="col-md-12 col-sm-12 col-xs-12 padisplay1 ">
                                      <div class="col-md-2 col-sm-3 col-xs-1 padd_beg">
                                          <img class="w-loc" src="<?php echo HTTP_ROOT?>/img/weight_loss/location.png" alt="img">
                                      </div>
                                      <div class="col-md-8 col-sm-9 col-xs-10 begin_lm cust-md-padd right-bgin-content booknow-content">
                                          <span class="sum-chennai"><?php echo $detail['VendorClasseLocationDetail'][0]['Locality']['name']; ?></span>
                                      </div>
                                    </div>
                                    <?php
                                        }
                                  ?>
                                  <?php if(!empty($detail['VendorClasse']['city'])){?>
                                   <div class="col-md-12 col-sm-12 col-xs-12 padisplay1 ">
                                      <div class="col-md-2 col-sm-3 col-xs-1 padd_beg">
                                          <img class="w-loc" src="<?php echo HTTP_ROOT?>/img/weight_loss/location.png" alt="img">
                                      </div>
                                      <div class="col-md-8 col-sm-9 col-xs-10 begin_lm cust-md-padd right-bgin-content booknow-content">
                                          <span class="sum-chennai">
										  City: <?php 
										  $city = $this->Layout->get_city($detail['VendorClasse']['city']);
										  echo $city['City']['name'];
                                  ...
                                  ?>
                                   ...
                                   <?php if(!empty($detail['VendorClasse']['region'])){?>
                                    <div class="col-md-12 col-sm-12 col-xs-12 padisplay1 ">
                                      <div class="col-md-2 col-sm-3 col-xs-1 padd_beg">
                                      ...
                                      <div class="col-md-8 col-sm-9 col-xs-10 begin_lm cust-md-padd right-bgin-content booknow-content">
                                          <span class="sum-chennai">
										Region:  <?php 
												$z= explode(',',$detail['VendorClasse']['region']);
												foreach($z as $x =>$value){
													if($x == 0): $c[$x] = 'North'; endif;
													if($x == 1): $c[$x]= 'East';endif;
													if($x == 2): $c[$x]= 'West';endif;
													if($x == 3): $c[$x]= 'South';endif;
												}  
												echo implode(',',$c);
											?>
										  </span>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 padisplay1 ">
                                      ...
                                      ?><?php */?>
                                      <?php if(!empty($detail['VendorClasse']['age_category'])){?>
                                    <div class="col-md-12 col-sm-12 col-xs-12 padisplay1 ">
                                      <div class="col-md-2 col-sm-3 col-xs-1 padd_beg">
                                         <img class="w-loc" src="<?php echo HTTP_ROOT?>/img/weight_loss/group.png" alt="img"> 
                                      </div>
                                      <div class="col-md-8 col-sm-9 col-xs-10 begin_lm cust-md-padd right-bgin-content booknow-content">
                                          <span class="sum-chennai">
                                         Age: <?php 
												$y= explode(',',$detail['VendorClasse']['age_category']);
												foreach($y as $v =>$value){
													if($v == 0): $y[$v] = 'Kids'; endif;
													if($v == 1): $y[$v]= 'Teens';endif;
													if($v == 2): $y[$v]= 'Adults';endif;
												}  
												echo implode(',',$y);
											?>
                                          </span>
                                    ...
                                    ?>
                                     <?php if(!empty($detail['VendorClasse']['group_id'])){?>
                                    <div class="col-md-12 col-sm-12 col-xs-12 padisplay1 ">
                                      <div class="col-md-2 col-sm-3 col-xs-1 padd_beg">
                                         <img class="w-loc" src="<?php echo HTTP_ROOT?>/img/weight_loss/group.png" alt="img"> 
                                      </div>
                                      <div class="col-md-8 col-sm-9 col-xs-10 begin_lm cust-md-padd right-bgin-content booknow-content">
                                          <span class="sum-chennai">
                                          Group: <?php
										 $groups =  explode(',',$detail['VendorClasse']['group_id']);
										  $group_val = '';
										  foreach($groups as $group){
											  	$g_val = $this->Layout->get_group($group);
											 $group_val=$group_val.",".$g_val['ConnectGroup']['group_name'];
											  }
											  echo $group_val;
										  ?>   
                                    ...
                                    ?>
                                     <?php if(!empty($detail['VendorClasse']['class_duration'])){?>
                                    <div class="col-md-12 col-sm-12 col-xs-12 padisplay1 ">
                                      <div class="col-md-2 col-sm-3 col-xs-1 padd_beg">
                                         <img class="w-loc" src="<?php echo HTTP_ROOT?>/img/weight_loss/group.png" alt="img"> 
                                      </div>
                        ...
                        <div class="modal-dialog" style="left:0%;">
                          <div class="modal-content col-xs-12 col-sm-12 padd_l_r">
                            ...
                            <div class="modal-body col-xs-12 col-sm-12 padd_l_r">
                              ...
                              <input type="hidden" name="us_id" id="us_id" value="<?php echo $detail['User']['id']; ?>">
                              <input type="hidden" name="us_id" id="us_id" value="<?php echo $detail['User']['id'] ?>">
