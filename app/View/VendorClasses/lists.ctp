...
.select-spl-bg{
  /*width:100%;
    ...
    border: none;*/
    /* background: transparent url("../img/caret1.png") no-repeat left center;*/
    background-image: url(../img/caret1.png);
           ...
           <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r tp_br">
            <div class="col-lg-3 col-md-4 col-sm-3 col-xs-5 padd_l_r">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 fldv1 list_filter">
                ...
                <div class="form-group mrg_btm">
                  <select class="form-control crt_br select-spl-bg" id="select">
                ...
                <div class="form-group mrg_btm">
                  <select class="form-control crt_br select-spl-bg" id="select" name="class_type">
                ...
                <div class="form-group mrg_btm">
                  <select class="form-control crt_br select-spl-bg" name="Community_id" id="select">
                ...
                <div class="form-group mrg_btm">
                  <select class="form-control crt_br select-spl-bg" id="select" name="class_schedule">
                ...
                <div class="form-group mrg_btm">
                  <select class="form-control crt_br select-spl-bg" id="select" name="class_provider">
...
<input type="hidden" name="seg_id" value="<?php echo $this->request->params['pass'][1];?>" />
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 fldv1 padd_l_r sort_by_br786">
              <article class="col-md-12 col-sm-12 col-xs-12 padd_l_r">
                <div class="col-md-12 col-sm-12 col-xs-12 fltrdv">
                  <div class="filter_br">
                    keywords
                  </div>
...
echo $this->Html->link($this->Html->image('Vendor/'.$result['VendorClasse']['category_id'].'/'.$seg_pic[0].'/defult_pic.jpg', array('class' => 'imgresponsive img-thumbnail')), array('controller'=>'Vendor_classes','action'=>'classes',$class_id), array('escape' => false));
 ...
 <?php 
								...
								<?php	
								echo $this->Image->resize('Vendor/class_image/'.$allclass_value['VendorClasse']['upload_class_photo'].'.jpg','305','148', array('class' => 'imgresponsive img-thumbnail'));
								?>
								</a>
								<?php  }else{
								$seg_pic = explode(',',$allclass_value['VendorClasse']['segment_id']);
								?>	  <a href="<?php echo HTTP_ROOT?>/classes/<?php echo $allclass_value['VendorClasse']['class_topic']; ?>" >
								<?php
								echo $this->Html->image('Vendor/'.$allclass_value['VendorClasse']['category_id'].'/'.$seg_pic[0].'/defult_pic.jpg', array('class' => 'imgresponsive img-thumbnail'));
								?>
								</a>
									<?php } ?>
                            </div>  
                          ...
                          <div class="col-md-8 col-sm-8 col-xs-12 text_res sr_2605_03_padding">
                             <div class="col-xs-12 col-sm-12 sr_2605_06 sr_2605_06_textLorem021">
                                ...
                                <a href="<?php echo HTTP_ROOT?>/classes/<?php echo $allclass_value['VendorClasse']['class_topic']; ?>" >
								<?php echo $allclass_value['VendorClasse']['class_topic']; ?></a>
