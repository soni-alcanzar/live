...
$.ajax({  
    ...
    data: 'coupon_number='+coupon_value+'&payment_amt='+amount+'&payment_type='+radioValue+'&status='+status+'&class_id='+class_id+'&no_of_ticket='+no_of_ticket+'&booking_id='+book_id,  
