    ...
    <!-- <input type="hidden" name="class_id" id="class_id" value=""/> -->
				...
				<div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 col-xs-12 book-no">
					...
					<div class="col-md-5 col-sm-5 col-xs-5 padd_l_r">
						...
						<input type="hidden" id="max_price" value="">
							<span class="book-avail">Ticket Price Rs : <?php echo $total_amount; ?></span>
						</div>
					</div>
				</div>
			</div>
		<div class="col-md-12 col-sm-12 col-xs-12 padd_l_r book-form-field">
           ...
           <div class="col-md-12 col-sm-12 col-xs-12 book-vd" id="coupon" style="display:none;">         
             ...
             <input type="hidden" name="" id="amount_copan" value="<?php echo $total_amount; ?>"/> 
					  	<span class="book-total" id="tp_rs"> Total Price: Rs. <?php echo $total_amount; ?>/- </span>
					  </div>
					</div>
					</div>
					</div>
...
if(email == '' || phone == '' || firstname == '' || user_id == ''){
		          $('#myModal').modal({
                                show: true,
                                backdrop: 'static',
                                keyboard: false
