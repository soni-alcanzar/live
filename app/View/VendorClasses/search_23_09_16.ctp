...
<div class="col-md-12 col-sm-12 col-xs-12 padd_l_r">
  <div class="col-md-12 col-sm-12 col-xs-12 padd_l_r">
    <a href="#">
    <img src="<?php echo HTTP_ROOT;?>/img/braingroom_group.jpg" class="img-responsive" alt="Braingroom">
    </a>
  </div>
</div>  
...
echo $this->Html->link($this->Image->resize('Vendor/class_image/'.$result['VendorClasse']['upload_class_photo'].'.jpg','305','148', array('class' => 'imgresponsive img-thumbnail')),array('controller'=>'Vendor_classes','action'=>'classes',$class_id),array('escape' => false));
...
echo $this->Html->link($this->Html->image('Vendor/'.$result['VendorClasse']['category_id'].'/'.$seg_pic[0].'/defult_pic.jpg', array('class' => 'imgresponsive img-thumbnail')), array('controller'=>'Vendor_classes','action'=>'classes',$class_id), array('escape' => false));
 ...
 ?>
									...
									echo $result['VendorClasse']['class_duration'];
									endif; ?> </h5>
                                    </div>
                                    </div>
                                    </li>
        ...
        <!-- end slider 1 -->
         ...
         <?php /*?>     <div class="col-md-2 col-sm-2 col-xs-3 rec_health padd_l_r one_seg12">
                 <?php if($cat_id==1){
                      echo 'Fun & Recreation';
                     }
                     else if($cat_id==2)
         ...
         <?php */?>     <div class="col-md-12 col-sm-12 col-xs-12 sr_2605_03_padding  sr_2705_bdr3 one_seg12 padd_l_r">

              
                    <div class="row">
                      <?php foreach ($categories as $key => $segment_value) {

                    $cat_id    =   $segment_value['Categories']['id'];
                    $cat_name  =   $segment_value['Categories']['category_name'];
                   
                    //$seg_id
                    ?>
                      <div class="col-md-3 col-sm-3 col-xs-3 padd_l_r two_seg seg_brd_tp_class_segment ">
                        <a href="javascript:void(0);" data-cat-id="<?php echo $cat_id;?>" class="js-load-classes"><?php echo $cat_name; ?></a>
                      </div> 
                      <?php 
                      }
                      ?>    
 ...
 ?>
                          ...
                          <div class="col-md-8 col-sm-8 col-xs-12 text_res sr_2605_03_padding">
                             <div class="col-xs-12 col-sm-12 sr_2605_06 sr_2605_06_textLorem021">
                                <div class="hathyga col-xs-12 col-sm-12"><?php echo $class_topic; ?>
                                ...
                                <div class="col-xs-12 col-sm-12 sr_2605_03_padding sr_2605_06_textLorem sr_serch_div_l_hite">
                                  ...
                                  <span class="comment more city"><?php echo $class_class_summary; ?></span>
                                </div>
 ...
 ?>
   ...
   <script type="text/javascript">
	...
	$('.js-load-classes').on('click',function (){
		...
		$.ajax({
			type: "POST", url: "/vendor_classes/load_classes/"+cat_id,
			data: $(this).serialize(),
			async: false,
