 		...
 		<div class="row">
 			<div class="col-md-12">
 				<div class="panel panel-default panel-primary">
 					<div class="panel-heading pannel-heading-strip"><i class="fa fa-gift"></i>&nbsp; Add NGO Card</div>
 					<div class="panel-body">
 							...
 							<div class="login-wrap" style="padding:0;margin:0px auto;">
 								...
 								<center>
 								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:15px;"><input type="submit" class="btn btn-default savebtn" style="background-color:#AB1A1F;color:#fff; !important;" value="Add NGO Card">
