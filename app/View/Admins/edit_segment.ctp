 	...
 	<section class="wrapper">
 		<div style="padding-top:20px" class="row">
 			<div style="" class="col-md-12">
 				<ol class="breadcrumb">
 					<li><a href="<?php echo HTTP_ROOT."/Admins/manageVendor";?>"><i class="fa fa-home"></i></a></li>
 		...
 		<div class="row">
 			<div class="col-md-12">
 				<div class="panel panel-default panel-primary">
 					<div class="panel-heading pannel-heading-strip"><i class="fa fa-edit"></i>&nbsp; Edit Segment</div>
 					<div class="panel-body">
 							...
 							<div class="login-wrap" style="padding:0;margin:0px auto;">
 								...
 								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
 									<?php echo $this->Form->input('segment_name', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Segment Name','value'=>$segment_name));?>
 								</div>
