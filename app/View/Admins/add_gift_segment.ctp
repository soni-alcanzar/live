 		...
 		<div style="padding-top:20px" class="row">
 			<div style="" class="col-md-12">
 				<ol class="breadcrumb">
 					...
 					<li><a href="<?php echo HTTP_ROOT."/Admins/manageGift";?>">Manage Gift</a></li>
 					<li><a href="<?php echo HTTP_ROOT."/Admins/addGiftSegment";?>">Add Gift Segment</a></li>
 				</ol>
 			</div>
 		</div>
 		...
 		<div class="row">
 			<div class="col-md-12">
 				<div class="panel panel-default panel-primary">
 					<div class="panel-heading pannel-heading-strip"><i class="fa fa-gift"></i>&nbsp; Add Gift Segment</div>
 					<div class="panel-body">
 						
 							 <?php echo $this->Form->create('GiftCardSegment',array('enctype'=>'multipart/form-data'));?>   
 							<div class="login-wrap" style="padding:0;margin:0px auto;">
 								...
 								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
 									<?php echo $this->Form->input('segment_id', array('type'=>'select','label' => false,'div'=>false, 'class' => 'form-control boxesstyle',
