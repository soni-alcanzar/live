 					...
 					<div class="panel-body">
 							...
 							<div class="login-wrap" style="padding:0;margin:0px auto;">
 								...
 								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
 									...
 									'value'=>$ngo_name['Ngo']['ngo_name']));?>
 								
 								</div>
                                                                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 boxesstyle">NGO Email</div>
 								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
 									<?php echo $this->Form->input('email', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Ngo Email',
 									'value'=>$ngo_name['Ngo']['email']));?>
