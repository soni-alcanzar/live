                        ...
                        <div class="panel-body">
                            ...
                            <table id="example" class="table table-striped table-bordered" style="table-layout: fixed;width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo !empty($res['Blog']['blog_title'])?$res['Blog']['blog_title']:"N/A";?>
                                    </td>
                                    <td>
                                        <?php echo !empty($res['Blog']['blog_description'])?$res['Blog']['blog_description']:"N/A";?>
                                    </td>
                                    <td>
                                        <?php if(!empty($res['Blog']['blog_image'])){?>
                                          
                                            <img src="<?php echo HTTP_ROOT."/img/blog_image/".$res['Blog']['blog_image'];?>" width="60" height="60">
                                        <?php }else{
                                    ...
                                    <td>
                                        <?php echo !empty(date('d M Y',$res['Blog']['add_date']))?date('d M Y',$res['Blog']['add_date']):"N/A";?>
                                    </td>
                                    <td>
                                        <?php if($res['Blog']['status']==1){
                                              echo "Approved";  
                                              }else if($res['Blog']['status']==2){
                                                echo "Rejected";
                                            }else if($res['Blog']['status']==0){
                                                echo "Pending";
                                            }
                                        ?>
                                    </td>
                                    <td>
                                        ...
                                        if($res['Blog']['status']=='0'){

                                            echo $this->Html->link('Accepted',array('controller'=>'Admins','action'=>'blogRequestaccept/'.base64_encode($res['Blog']['id'])))."&nbsp;|&nbsp;";
                                            echo $this->Html->link('Rejected',array('controller'=>'Admins','action'=>'blogRequestrejected/'.base64_encode($res['Blog']['id'])))."&nbsp;";
                                        }
                                       
                                       if($res['Blog']['status']=='1'){
                                            echo $this->Html->link('Rejected',array('controller'=>'Admins','action'=>'blogRequestrejected/'.base64_encode($res['Blog']['id'])));
                                       }
                                    ?>
                                    </td>
