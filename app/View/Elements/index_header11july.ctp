              ...
              <!-- <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 br_pad brn_pad"> -->
                 <!--  <div class="col-sm-12  col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 col-xs-12 brn_pad"> -->
                      <div class="col-md-3 col-sm-3 col-xs-12 b_logo brn_pad b_widh">
                          <img src="<?php echo HTTP_ROOT;?>/img/logo.jpg" style="width:210px" class="blwdh">
                      </div>
                      <!-- ******************new alignment***************** -->
                      <div class="col-md-6 col-sm-5 col-xs-12 padd_l_r b_fcb1 b_pad1">
                        <center class="bl_cntr">
                          <form action="Homes/fun" name="s_cat" method="post">
    ...
    <nav class="navbar navbar-default" role="navigation padd_l_r"> 
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li class="dropdown active first">
              <a href="<?php echo HTTP_ROOT;?>/homes/fun/1" class="# pad_right_5">Fun & Recreation<span class="fa fa-angle-down"></span></a>
            ...
            <li class="dropdown active">
              <a href="<?php echo HTTP_ROOT;?>/homes/fun/2" class="# pad_right_5">Informative & Motivational<span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu" style="background-color:#00FFFF; z-index:100000;">
            ...
            <li class="dropdown active">
              <a href="<?php echo HTTP_ROOT;?>/homes/fun/3" class="# pad_right_5">Health & Wellness<span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu" style="background-color:#00FFFF; z-index:100000;">
            ...
            <li class="dropdown active">
              <a href="<?php echo HTTP_ROOT;?>/homes/fun/4" class="# pad_right_5" >Kids & Teens<span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu" style="background-color:#00FFFF; z-index:100000;">
            ...
            <li class="dropdown active">
              <a href="<?php echo HTTP_ROOT;?>/homes/fun/5" class="# pad_right_5" >Education & Skill Development<span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu" style="background-color:#00FFFF; z-index:100000;">
            ...
            <li class="dropdown active last">
              <a href="<?php echo HTTP_ROOT;?>/homes/fun/6" class="# pad_right_5">Home Maintenance<span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu" style="background-color:#00FFFF; z-index:100000;">
