        ...
        <div class="row">
            <div class="col-md-12" style="padding-top:15px">
                <ol class="breadcrumb">
                    ...
                    <li class="active">View Gift Segment</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="dashboard-main">
                    <div class="panel panel-default panel-primary ">
                        <div class="panel-heading strip pannel-heading-strip"><i class="fa fa-pencil-square-o"></i>&nbsp; View Gift Segment</div>
                        <div class="panel-body">
                            ...
                            <table id="example" class="table table-striped table-bordered" style="table-layout: fixed;width: 100%;">
                                ...
                                for($p=0;$p<(count($all_segment));$p++){
                                 //print_r($res);die;?>
                                <tr>
                                    <td><?php echo $i; $i++;?></td>
                                    <td><?php echo !empty($all_segment[$p])?$all_segment[$p]:"N/A";?></td>
