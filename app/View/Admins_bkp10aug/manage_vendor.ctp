            ...
            <div class="col-md-12">
                <div class="dashboard-main">
                    <div class="panel panel-default panel-primary ">
                        <div class="panel-heading strip pannel-heading-strip"><i class="fa fa-pencil-square-o"></i>&nbsp; Manage Vendor</div>
                        <div class="panel-body">
                            ...
                            <table id="example" class="table table-striped table-bordered" style="table-layout: fixed;width: 100%;">
                                ...
                                <?php 
                                $i=1;
                                foreach($view_vendor as $res){ ?>
                                <tr>
                                    <td><?php echo $i; $i++;?></td>
                                    <td><?php echo !empty($res['UserMaster']['first_name'])?$res['UserMaster']['first_name']:"N/A";?></td>
                                    ...
                                    $locality[$res['UserMaster']['id']]:"N/A";?></td>
                                     <td style="word-wrap: break-word;"><?php if(!empty($res['UserMaster']['profile_image'])){?>
                                        <img src="<?php echo HTTP_ROOT."/img/Vendor/profile/".$res['UserMaster']['profile_image'];?>" width="60" height="60">
                                     <?php }else{
                                       echo "N/A";
                                     }?></td> 
                                    ...
                                    <td><?php echo $this->Html->link('View',array('controller'=>'Admins','action'=>'view/'.base64_encode($res['UserMaster']['id'])))."&nbsp;|&nbsp;";
                                       echo $this->Html->link('Edit',array('controller'=>'Admins','action'=>'editVendor/'.base64_encode($res['UserMaster']['id'])))."&nbsp;|&nbsp;";
