  ...
  <head>
    ...
    <?php 
            ...
            echo $this->Html->css('connect/connect');
             echo $this->Html->css('connect/paydetail');
            echo $this->Html->css('data_table/jquery.dataTables.min');   
	    ...
	    echo $this->Html->script('front/jquery.bxslider');
            echo $this->Html->script('data_table/jquery.dataTables.min'); 
        ?><!-- Braingroom modifications -->
      ...
      <script type="text/javascript">
        ...
        // **********first id***********//
          ...
          // ******* start vendor lside rahul 
            ...
            // });
          // ******* end vendor lside rahul

          // ******* Start vendor lside  Rohit 16_07
          $("#vndr1").click(function(){
              $("#vndr").show();
              $("#buyer").hide();
              $("#work1").show();
