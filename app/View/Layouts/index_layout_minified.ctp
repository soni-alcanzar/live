...
<html lang="en">
  <head>
    ...
    <title>Braingroom</title>
     ...
     <!-- The styles -->
     <?php 
	  echo $this->Html->css('front/production'); 
	//  echo $this->Html->script('front/output.min');
	 ?>
	     <?php /*?> <?php 
    ...
    <body>
     ...
     <script defer="defer" type="text/javascript" src="<?php echo HTTP_ROOT;?>/js/front/output.min.js">
</script>
    </body>
</html>
